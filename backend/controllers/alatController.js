...
exports.createAlat = async (req, res) => {
    try {
        ...
        // Validation - kode_alat is now auto-generated if not provided
        ...
        // Insert alat - kode_alat will be generated by trigger if null
...
exports.deleteAlat = async (req, res) => {
    try {
        ...
        if (error.sqlMessage && (error.sqlMessage.includes('peminjaman aktif') || error.sqlMessage.includes('foreign key constraint'))) {
            return res.status(400).json({
                success: false,
                message: 'Cannot delete alat that is currently being used in active loans'
            });
        }
